...
\begin{lstlisting}
	...
	public class TipoUsuario extends Entity<Integer>
\end{lstlisting}
...
\begin{lstlisting}
	...
	@GeneratedValue(strategy = GenerationType.AUTO, 
			generator = "Sexo_Generator")
	@SequenceGenerator(name = "Sexo_Generator", 
			sequenceName = "Sexo_Generator")
...
\begin{lstlisting}
	...
	@JoinTable(name = "RESULTADO_RESPUESTA"), 
		joinColumns = {@JoinColumn(name = "RESULTADO") }, 
		inverseJoinColumns = {JoinColumn(name = "RESPUESTA")})
