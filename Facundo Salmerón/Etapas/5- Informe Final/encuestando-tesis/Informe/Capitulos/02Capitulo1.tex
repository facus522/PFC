...
\begin{itemize}
	...
	Se trata de una request del tipo GET que recibe como parámetro el id de la encuesta a analizar. Se envían todas las resoluciones pertinentes a dicha encuesta, para que de ésta forma la aplicación móvil realice todas las estadísticas necesarias para presentar en pantalla.
