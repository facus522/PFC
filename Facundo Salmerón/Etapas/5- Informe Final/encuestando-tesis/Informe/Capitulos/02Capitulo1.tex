...
\chapter{Diseño y desarrollo de software para el servidor}
...
\begin{figure}[h!]
	\begin{center}
		...
		\small\textsuperscript{\textit{Imagen: http://www.ytechie.com/2008/06/i-finally-get-the-point-of-inversion-of-control/}}
		\label{fig:ioc}
	\end{center}
\end{figure}
...
\begin{figure}[h!]
	\makebox[\textwidth][c]{\includegraphics[width=1.6\textwidth, height=1.6\textwidth]{Imagenes/Bitmap/diagrama_ws}}%
